...
if(localStorage!==0){
    document.getElementById("avialRecords").innerHTML = `Records Available in Local Storage`;
}
...
for(let index=0;index<localStorage.length; index++){
    ...
    document.getElementById("lsOutput").innerHTML += `<br><hr><br> key is : ${key} <br> Value is : ${value} <br> <br>`;
